...
public class XueshengchuqinView extends XueshengchuqinEntity implements Serializable {
	...
	public XueshengchuqinView() {

	}

	public XueshengchuqinView(XueshengchuqinEntity xueshengchuqinEntity) {
		try {
			BeanUtils.copyProperties(this, xueshengchuqinEntity);

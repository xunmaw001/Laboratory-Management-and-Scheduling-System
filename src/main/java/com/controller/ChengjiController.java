    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(chengji !=null){
            ...
            BeanUtils.copyProperties( chengji , view );//把实体数据重构到view中
                ...
                //级联表
                ShiyanshipaikeEntity shiyanshipaike = shiyanshipaikeService.selectById(chengji.getShiyanshipaikeId());
                if(shiyanshipaike != null){
                    BeanUtils.copyProperties( shiyanshipaike , view ,new String[]{ "id", "createTime", "insertTime", "updateTime"});//把级联的数据添加到view中,并排除id和创建时间字段
                    view.setShiyanshipaikeId(shiyanshipaike.getId());
                }
                //级联表
...
//                            chengjiEntity.setShiyanshipaikeId(Integer.valueOf(data.get(0)));   //实验室排课 要改的
//                            chengjiEntity.setChengjiLeixingTypes(Integer.valueOf(data.get(0)));   //类型 要改的
//                            chengjiEntity.setChengjiNumber(Integer.valueOf(data.get(0)));   //分数 要改的
//                            chengjiEntity.setChengjiTime(new Date(data.get(0)));          //考试时间 要改的

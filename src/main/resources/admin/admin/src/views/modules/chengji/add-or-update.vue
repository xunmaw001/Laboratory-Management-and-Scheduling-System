<template>
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                <el-col :span="12"  v-if="sessionTable !='shiyanshipaike'">
                    <el-form-item class="select" v-if="type!='info'"  label="实验室排课" prop="shiyanshipaikeId">
                        <el-select v-model="ruleForm.shiyanshipaikeId" :disabled="ro.shiyanshipaikeId" filterable placeholder="请选择实验室排课" @change="shiyanshipaikeChange">
                            <el-option
                                    v-for="(item,index) in shiyanshipaikeOptions"
                                    v-bind:key="item.id"
                ...
                <el-col :span="12"  v-if="sessionTable !='shiyanshipaike' ">
                    <el-form-item class="input" v-if="type!='info'"  label="班级" prop="banjiValue">
                        <el-input v-model="shiyanshipaikeForm.banjiValue"
                ...
                <el-col :span="12"  v-if="sessionTable !='shiyanshipaike' ">
                    <el-form-item class="input" v-if="type!='info'"  label="星期" prop="xingqiValue">
                        <el-input v-model="shiyanshipaikeForm.xingqiValue"
                ...
                <el-col :span="12"  v-if="sessionTable !='shiyanshipaike' ">
                    <el-form-item class="input" v-if="type!='info'"  label="节数" prop="jieshuValue">
                        <el-input v-model="shiyanshipaikeForm.jieshuValue"
                                  placeholder="节数" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="节数" prop="jieshuValue">
            ...
            <input id="shiyanshipaikeId" name="shiyanshipaikeId" type="hidden">
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="类型" prop="chengjiLeixingTypes">
                        <el-select v-model="ruleForm.chengjiLeixingTypes" :disabled="ro.chengjiLeixingTypes" placeholder="请选择类型">
                            <el-option
                                v-for="(item,index) in chengjiLeixingTypesOptions"
                    ...
                    <div v-else>
                        <el-form-item class="input" label="类型" prop="chengjiLeixingValue">
                        <el-input v-model="ruleForm.chengjiLeixingValue"
                            placeholder="类型" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="分数" prop="chengjiNumber">
                       <el-input v-model="ruleForm.chengjiNumber"
                                 placeholder="分数" clearable  :readonly="ro.chengjiNumber"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="分数" prop="chengjiNumber">
                           <el-input v-model="ruleForm.chengjiNumber"
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  class="input" label="考试时间" prop="chengjiTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd HH:ss:mm"
                                v-model="ruleForm.chengjiTime"
                                type="datetime"
                                placeholder="考试时间"
                                :disabled="ro.chengjiTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.chengjiTime" label="考试时间" prop="chengjiTime">
                            <span v-html="ruleForm.chengjiTime"></span>
                        </el-form-item>
                    </div>
                </el-col>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    xueshengId: false,
                    shiyanshipaikeId: false,
                    chengjiLeixingTypes: false,
                    chengjiNumber: false,
                    chengjiTime: false,
                    insertTime: false,
                },
                ...
                chengjiLeixingTypesOptions : [],
                shiyanshipaikeOptions : [],
                xueshengOptions : [],
                rules: {
                   xueshengId: [
                   ...
                   shiyanshipaikeId: [
                              { required: true, message: '实验室排课不能为空', trigger: 'blur' },
                              {  pattern: /^[1-9][0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=chengji_leixing_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.chengjiLeixingTypesOptions = data.data.list;
                    }
                });

         this.$http({
             url: `shiyanshipaike/page?page=1&limit=100`,
             method: "get"
         }).then(({ data }) => {
             if (data && data.code === 0) {
                this.shiyanshipaikeOptions = data.data.list;
            }
         });
         this.$http({
        ...
        methods: {
            ...
            shiyanshipaikeChange(id){
                this.$http({
                    url: `shiyanshipaike/info/`+id,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.shiyanshipaikeForm = data.data;
                    }
                });
            },
            xueshengChange(id){
            ...
            info(id) {
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        _this.shiyanshipaikeChange(data.data.shiyanshipaikeId)

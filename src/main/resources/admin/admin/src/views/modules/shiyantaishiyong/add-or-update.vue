<template>
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                <el-col :span="12"  v-if="sessionTable !='shiyantai'">
                    <el-form-item class="select" v-if="type!='info'"  label="实验台" prop="shiyantaiId">
                        <el-select v-model="ruleForm.shiyantaiId" :disabled="ro.shiyantaiId" filterable placeholder="请选择实验台" @change="shiyantaiChange">
                            <el-option
                                    v-for="(item,index) in shiyantaiOptions"
                                    v-bind:key="item.id"
                                    :label="item.shiyantaiName"
                                    :value="item.id">
                            </el-option>
                        </el-select>
                    </el-form-item>
                ...
                <el-col :span="12"  v-if="sessionTable !='shiyantai' ">
                    <el-form-item class="input" v-if="type!='info'"  label="实验台编号" prop="shiyantaiBianhao">
                        <el-input v-model="shiyantaiForm.shiyantaiBianhao"
                                  placeholder="实验台编号" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                ...
                <el-col :span="12"  v-if="sessionTable !='shiyantai' ">
                    <el-form-item class="input" v-if="type!='info'"  label="实验台名称" prop="shiyantaiName">
                        <el-input v-model="shiyantaiForm.shiyantaiName"
                                  placeholder="实验台名称" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                ...
                <el-col :span="12"  v-if="sessionTable !='shiyantai' ">
                    <el-form-item class="input" v-if="type!='info'"  label="所在位置" prop="shiyantaiWeizhi">
                        <el-input v-model="shiyantaiForm.shiyantaiWeizhi"
            ...
            <input id="shiyantaiId" name="shiyantaiId" type="hidden">
            <input id="xueshengId" name="xueshengId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="备注" prop="shiyantaishiyongContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.shiyantaishiyongContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.shiyantaishiyongContent" label="备注" prop="shiyantaishiyongContent">
                            <span v-html="ruleForm.shiyantaishiyongContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    shiyantaiId: false,
                    xueshengId: false,
                    shiyantaishiyongContent: false,
                    insertTime: false,
                },
                ruleForm: {
                    shiyantaiId: '',
                    xueshengId: '',
                    shiyantaishiyongContent: '',
                    insertTime: '',
                },
                shiyantaiOptions : [],
                xueshengOptions : [],
        ...
        created() {
         ...
         this.$http({
             url: `shiyantai/page?page=1&limit=100`,
             method: "get"
         }).then(({ data }) => {
             if (data && data.code === 0) {
                this.shiyantaiOptions = data.data.list;
            }
         });
         this.$http({
        ...
        methods: {
            ...
            info(id) {
                let _this =this;
                _this.$http({
                    url: `shiyantaishiyong/info/${id}`,
                    method: 'get'
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        _this.ruleForm = data.data;
                        _this.shiyantaiChange(data.data.shiyantaiId)
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`shiyantaishiyong/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.shiyantaishiyongCrossAddOrUpdateFlag = false;
                                        this.parent.search();

    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="12"  v-if="sessionTable !='shebei' ">
                    <el-form-item class="input" v-if="type!='info'"  label="设备数量" prop="shebeiNumber">
                        <el-input v-model="shebeiForm.shebeiNumber"
                                  placeholder="设备数量" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
            ...
            <input id="xueshengId" name="xueshengId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="借出数量" prop="shebeijiechuNumber">
                       <el-input v-model="ruleForm.shebeijiechuNumber"
                                 placeholder="借出数量" clearable  :readonly="ro.shebeijiechuNumber"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="借出数量" prop="shebeijiechuNumber">
                           <el-input v-model="ruleForm.shebeijiechuNumber"
                                     placeholder="借出数量" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="备注" prop="shebeijiechuContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.shebeijiechuContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.shebeijiechuContent" label="备注" prop="shebeijiechuContent">
                            <span v-html="ruleForm.shebeijiechuContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  class="input" label="借出时间" prop="jiechuTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd HH:ss:mm"
                                v-model="ruleForm.jiechuTime"
                                type="datetime"
                                placeholder="借出时间"
                                :disabled="ro.jiechuTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.jiechuTime" label="借出时间" prop="jiechuTime">
                            <span v-html="ruleForm.jiechuTime"></span>
                        </el-form-item>
                    </div>
                </el-col>

                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  class="input" label="归还时间" prop="guihuanTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd HH:ss:mm"
                                v-model="ruleForm.guihuanTime"
                                type="datetime"
                                placeholder="归还时间"
                                :disabled="ro.guihuanTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.guihuanTime" label="归还时间" prop="guihuanTime">
                            <span v-html="ruleForm.guihuanTime"></span>
                        </el-form-item>
                    </div>
                </el-col>
        ...
        data() {
            return {
                ...
                ro:{
                    shebeiId: false,
                    xueshengId: false,
                    shebeijiechuNumber: false,
                    shebeijiechuContent: false,
                    jiechuTime: false,
                    guihuanTime: false,
                    insertTime: false,
                },
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`shebeijiechu/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.shebeijiechuCrossAddOrUpdateFlag = false;
                                        this.parent.search();

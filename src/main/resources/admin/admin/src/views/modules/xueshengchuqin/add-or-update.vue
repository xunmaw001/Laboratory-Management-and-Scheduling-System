    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="xueshengId" name="xueshengId" type="hidden">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="备注" prop="xueshengchuqinContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.xueshengchuqinContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.xueshengchuqinContent" label="备注" prop="xueshengchuqinContent">
                            <span v-html="ruleForm.xueshengchuqinContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
        ...
        data() {
            return {
                ...
                ro:{
                    ...
                    insertTime: false,
                    xueshengchuqinContent: false,
                },
                ruleForm: {
                    xueshengId: '',
                    shiyanshikemuTypes: '',
                    insertTime: '',
                    xueshengchuqinContent: '',
                },
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`xueshengchuqin/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.xueshengchuqinCrossAddOrUpdateFlag = false;
                                        this.parent.search();

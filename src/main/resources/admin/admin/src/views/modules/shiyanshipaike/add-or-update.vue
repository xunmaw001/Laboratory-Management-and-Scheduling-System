    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="laoshiId" name="laoshiId" type="hidden">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="节数" prop="jieshuTypes">
                        <el-select v-model="ruleForm.jieshuTypes" :disabled="ro.jieshuTypes" placeholder="请选择节数">
                            <el-option
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`shiyanshipaike/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.shiyanshipaikeCrossAddOrUpdateFlag = false;
                                        this.parent.search();
